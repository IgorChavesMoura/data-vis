// https://observablehq.com/@igorchavesmoura/taxa-de-desemprego-nos-eua-em-agosto-de-2016-parte-2@92
...
d3.tsv("https://gist.githubusercontent.com/emanueles/7fbdcd8ee412e3e63904114cf9d7ee3a/raw/af4fd93db1be3f9033caff46d4a574a54bf9363f/unemployment.tsv").then(function (data) {
  ...
  main.variable(observer("showTooltip")).define("showTooltip", ["d3","countiesNames","rateById"], function(d3,countiesNames,rateById){return(
function showTooltip(county_id, x, y){
  ...
  d3.select("#nome")
  .text(countiesNames.get(county_id))
  ...
  main.variable(observer("tooltip")).define("tooltip", ["d3"], function(d3)
{
  ...
  let node = d3.select("body")
    ...
    .attr("class","hidden")
    .append("p")
    .html(`<strong id='nome'></strong><br>
           Taxa de desemprego: <span id='taxa'></span>%`)
...
d3.json("https://gist.githubusercontent.com/emanueles/ee2997bc6237f3dcab952ae8becaf6bf/raw/afdb12d4ef89bb239998b295c94d960e8d89c19e/us.json")
  ...
  main.variable(observer("countiesNames")).define("countiesNames", ["d3"], function(d3){return(
